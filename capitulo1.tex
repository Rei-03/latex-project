...
\hline
Cargas horarias (MW) & SIGERE: ap\_curvas & Consumo de megavatios por hora para cada circuito \\
\hline
MWh totales por circuito & SIGERE: ap\_mwxHora & Energía acumulada en mega\-vatios-horas \\
\hline
Órdenes DNC & SIGERE: ap\_OrdenesDNC & Restricciones y prioridades del DNC \\
\hline
Circuitos asegurados & PSFV: ap\_Aseguramientos & Circuitos críticos (hospitales, servicios) \\
\hline
Estado operativo & SIGERE: MSM\_Aseguramientos & Circuitos averiados o en mantenimiento \\
\hline
Bloques operativos & SIGERE: ap\_RotacionBloques & Segmentación de circuitos para rotación \\
\hline
\end{tabular}
